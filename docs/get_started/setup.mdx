...
if you are linking the [Xiph libraries](/get_started/no_opus_ogg_libs) (the default), you can also choose to use the `TRY_SYSTEM_LIBS_FIRST=1` environment variable to link the onces available in the system:
