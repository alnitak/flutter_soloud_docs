...
The *OGG*, *Opus*, *Vorbis*, and *FLAC* libraries are embedded by default in flutter_soloud. However, if you don't need streaming capabilities, you can exclude these libraries to reduce your app's binary size by 600~1500 KB (depending on platform).
