...
<Info>
Compressed formats (`opus`, `vorbis`, `flac`) require the plugin to be built with the Xiph libraries. See the [Without Xiph libs](/get_started/no_xiph_libs) page for more details.
</Info>
