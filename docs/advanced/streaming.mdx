...
| `format`               | Audio data format. Options: `f32le`, `s8`, `s16le`, `s32le`, `mp3`, or`auto` (OGG/Opus, OGG/Vorbis, or MP3 formats supported). <br/>**Note:** for MP3s with TAGs and artwork image, all the audio data must be received before the playback is started.|
