...
| `format`               | Audio data format. Options: `f32le`, `s8`, `s16le`, `s32le`, or`auto` (OGG/Opus, OGG/Vorbis, or MP3 formats are automatically detected). <br/>**Note:** the `auto` autodetect MP3 and Ogg container with Opus or Vorbis.|
