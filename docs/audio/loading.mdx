...
When there is a need to load a bunch of audio files at once, it is recommended to use the `wait` method a a List of Future, which will perform the loading 20~40% faster.
